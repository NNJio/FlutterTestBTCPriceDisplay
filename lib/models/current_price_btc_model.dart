...
CurrentPriceBtcModel currentPriceBtcModelFromJson(String str) =>
    CurrentPriceBtcModel.fromJson(json.decode(str));

String currentPriceBtcModelToJson(CurrentPriceBtcModel data) =>
    json.encode(data.toJson());

class CurrentPriceBtcModel {
  Time? time;
  String? disclaimer;
  String? chartName;
  Bpi? bpi;

  CurrentPriceBtcModel({
     this.time,
     this.disclaimer,
     this.chartName,
     this.bpi,
  ...
  factory CurrentPriceBtcModel.fromJson(Map<String, dynamic> json) =>
      CurrentPriceBtcModel(
